...
<head>
    ...
    <title>Ajouter un Produit - GreenTech Solutions</title>
...
<aside class="sidebar">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="/admin/products" class="sidebar-link active flex items-center gap-3 px-4 py-3 text-white rounded-lg">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<main class="main-content p-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800 heading-font">Ajouter un Produit</h1>
                <p class="text-gray-500 mt-1">Créez un nouveau produit écologique</p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="form-container">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" id="name" name="name" class="form-input" placeholder="Ex: Monstera Deliciosa" required>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="sku" class="form-label">SKU *</label>
                                <input type="text" id="sku" name="sku" class="form-input" placeholder="PLN-001" required>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" class="form-textarea" placeholder="Décrivez votre produit en détail..." required></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-container">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" id="price" name="price" class="form-input" placeholder="120" step="0.01" required>
                        </div>

                        <div>
                            <label for="stock" class="form-label">Quantité en stock *</label>
                            <input type="number" id="stock" name="stock" class="form-input" placeholder="45" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-container">
                    ...
                    <div class="file-upload-area">
                        ...
                        <label for="image" class="cursor-pointer">
                            <span class="text-sm font-semibold" style="color: var(--sage);">Cliquez pour uploader</span>
            ...
            <div class="space-y-6">
                ...
                <div class="form-container">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="bio" class="w-4 h-4 rounded" style="accent-color: var(--sage);">
                            <span class="text-sm text-gray-700">🌱 Produit Bio</span>
                        </label>

                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="local" class="w-4 h-4 rounded" style="accent-color: var(--sage);">
                            <span class="text-sm text-gray-700">📍 Production Locale</span>
                        </label>

                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="eco" class="w-4 h-4 rounded" style="accent-color: var(--sage);">
                            <span class="text-sm text-gray-700">♻️ Éco-responsable</span>
                        </label>

                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="featured" class="w-4 h-4 rounded" style="accent-color: var(--sage);">
