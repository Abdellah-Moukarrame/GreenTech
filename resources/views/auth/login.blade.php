    ...
    <div class="w-full max-w-6xl flex items-center gap-12">
        ...
        <div class="flex-1 max-w-md w-full">
            <div class="glass rounded-3xl shadow-2xl p-10">
                ...
                <!-- Login Form -->
                <form class="space-y-6" method="POST" action="{{route('login.login')}}">
                    @csrf
                    <!-- Email Input -->
                    <div>
            ...
            <div class="mt-6 text-center">
                <a href="/auth/register" class="inline-flex items-center gap-2 text-sm text-gray-600 transition-colors">
