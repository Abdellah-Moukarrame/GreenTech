    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 heading-font">Détails du Produit</h1>
                    <p class="text-gray-500 mt-1">Consultez toutes les informations du produit</p>
                </div>
            </div>

            <div class="flex items-center gap-3">
                <a href="/admin/update/1" class="btn-primary">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/admin/delete/1" class="btn-danger">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
            <div class="detail-card">
                ...
                <div class="flex items-center justify-center gap-2 mt-4">
                    <span class="badge badge-success">🌱 Bio</span>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="detail-card">
                ...
                <div>
                    <div class="info-row">
                        ...
                        <div class="info-value">Monstera Deliciosa</div>
                    </div>

                    <div class="info-row">
                        <div class="info-label">SKU</div>
                        <div class="info-value">PLN-001</div>
                    </div>

                    <div class="info-row">
                        <div class="info-label">Catégorie</div>
                        <div class="info-value">🌿 Plantes</div>
                    </div>

                    <div class="info-row">
                        <div class="info-label">Description</div>
                        <div class="info-value">
                            Plante tropicale facile d'entretien, parfaite pour purifier l'air de votre intérieur.
                            La Monstera Deliciosa est connue pour ses grandes feuilles découpées et sa croissance rapide.
                            Idéale pour les débutants en jardinage.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div>
                    <div class="info-row">
                        ...
                        <div class="info-value">
                            <span class="text-2xl font-bold" style="color: var(--sage);">120 DH</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div>
                    <div class="info-row">
                        <div class="info-label">Produit Bio</div>
                        <div class="info-value">
                            <svg class="w-5 h-5 inline" style="color: var(--sage);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="info-row">
                        <div class="info-label">Production Locale</div>
                        <div class="info-value">
                            <svg class="w-5 h-5 inline" style="color: var(--sage);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                    ...
                    <div class="info-row">
                        <div class="info-label">Éco-responsable</div>
                        <div class="info-value">
                            <svg class="w-5 h-5 inline" style="color: var(--sage);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                    ...
                    <div class="info-row">
                        <div class="info-label">Produit Vedette</div>
                        <div class="info-value">
                            <svg class="w-5 h-5 inline" style="color: var(--sage);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-value">15 janvier 2026</div>
                    </div>

                    <div class="info-row">
                        <div class="info-label">Dernière modification</div>
                        <div class="info-value">20 janvier 2026</div>
                    </div>
                </div>
            </div>
        </div>
